...
public class Date {
	...
	private void setDay(int day) {
		...
		if(day < 1 || day > 31){
			throw new IllegalArgumentException("The day must be between 1 and 31. (Inclusive)");
		}
		...
		if(this.month == 2 && ((isLeapYear() && day > 29) || (!isLeapYear() && day > 28))){
			throw new IllegalArgumentException("The day must be less than 28/29 for month " +  monthNames[month-1] + "on a non-leap year/leap year");
		}
		this.day = day;
	}
